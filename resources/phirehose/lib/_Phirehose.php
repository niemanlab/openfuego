...
abstract class Phirehose
{
  ...
  */
   ...
   */
  public function consume($reconnect = FALSE) {
    // Persist connection?
...
/*       $this->reconnect = !$this->shouldStop(); */
      
      // Reconnect
    } while ($this->reconnect/*  && !$this->shouldStop() */);
  ...
  protected function connect()
  {
    ...
    do {
      ...
      // Debugging is useful
      $this->log('Connecting to twitter stream: ' . $urlParts
